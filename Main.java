...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        getContentPane().setBackground(Color.PINK); //Cambia el color de fondo de la ventana a rosa.
        ...
        btnRegistrar.setBackground(Color.GREEN); // Cambia el color de fondo del botón a verde.
        ...
        add(txtname); // Agrega el campo de texto del nombre.
        add(lblPrecio); // Agrega la etiqueta de precio.
        add(txtprice); // Agrega el campo de texto del precio.
    ...
    private void registrarProducto() {
        String nombre = txtname.getText(); // Obtiene el nombre escrito por el usuario.
        double precio = Double.parseDouble(txtprice.getText()); // Convierte el texto del precio a double.
